...
<!-- [ Header ] end -->
    ...
    class obt_product
    {
      ...
      private $authToken = '1797|4x5bKd0YNYeohykmKVP6aEWlWbm5zcZTisNQz43e';
              ...
              <div class="card product-card shadow-sm mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <a href="product_details.php?id=<?= htmlspecialchars($producto['id']) ?>"
                      class="btn btn-info btn-sm">Detalles</a>
                    <a href="=<?= htmlspecialchars($producto['id']) ?>"
                      class="btn btn-warning btn-sm">Editar</a>
                    <form action="../../app/ProductsController.php?action=delete" method="POST" class="mt-2">
